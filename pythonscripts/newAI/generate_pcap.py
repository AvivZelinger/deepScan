...
def generate_pcap(file_name, num_packets=100):
    ...
    print(f"PCAP file '{file_name}' generated with {num_packets} packets.")

if __name__ == '__main__':
    # יצירת מספר קבצי PCAP לאימון
    for i in range(1, 4):
        generate_pcap(f"sample_{i}.pcap", num_packets=100)
    
    # יצירת קובץ PCAP לבדיקה
