-- Wireshark Lua dissector for aviv zli on IP 192.168.4.40
-- This file was generated automatically from the DPI JSON description.

local aviv zli_192_168_4_40 = Proto("aviv zli_192_168_4_40", "aviv zli for IP 192.168.4.40")

local f_checksum = ProtoField.uint32("aviv zli_192_168_4_40.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("aviv zli_192_168_4_40.end_flag", "End_flag")
local f_flag = ProtoField.string("aviv zli_192_168_4_40.flag", "Flag")
local f_id = ProtoField.uint32("aviv zli_192_168_4_40.id", "Id"), base.DEC
local f_length = ProtoField.uint32("aviv zli_192_168_4_40.length", "Length"), base.DEC
local f_message = ProtoField.string("aviv zli_192_168_4_40.message", "Message")

aviv zli_192_168_4_40.fields = { f_checksum, f_end_flag, f_flag, f_id, f_length, f_message }

function aviv zli_192_168_4_40.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "aviv zli (192.168.4.40)"
    local subtree = tree:add(aviv zli_192_168_4_40, buffer(), "aviv zli for IP 192.168.4.40")
    local offset = 0
    ...
    if checksum < 115045099 or checksum > 4101309716 then
...
udp_port:add(10000, aviv zli_192_168_4_40)
