-- Wireshark Lua dissector for tamir5 on IP 192.168.4.40
-- Generated automatically from DPI JSON.

local tamir5_192_168_4_40 = Proto("tamir5_192_168_4_40", "tamir5 for IP 192.168.4.40")

local f_sync = ProtoField.uint8("tamir5_192_168_4_40.sync", "Sync"), base.DEC
local f_id = ProtoField.uint32("tamir5_192_168_4_40.id", "Id"), base.DEC
local f_type = ProtoField.uint32("tamir5_192_168_4_40.type", "Type"), base.DEC
local f_length = ProtoField.uint32("tamir5_192_168_4_40.length", "Length"), base.DEC
local f_payload = ProtoField.string("tamir5_192_168_4_40.payload", "Payload")
local f_crc = ProtoField.uint32("tamir5_192_168_4_40.crc", "Crc"), base.DEC
local f_flag = ProtoField.uint8("tamir5_192_168_4_40.flag", "Flag"), base.DEC

tamir5_192_168_4_40.fields = { f_sync, f_id, f_type, f_length, f_payload, f_crc, f_flag }

function tamir5_192_168_4_40.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "tamir5"
    local subtree = tree:add(tamir5_192_168_4_40, buffer(), "tamir5 for IP 192.168.4.40")
    local offset = 0
    ...
    do
        local min_val = 232297096
        local max_val = 4100283207
...
udp_port:add(10000, tamir5_192_168_4_40)
