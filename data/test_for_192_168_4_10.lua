-- Wireshark Lua dissector for test on IP 192.168.4.10
-- Generated automatically from DPI JSON.

local test_192_168_4_10 = Proto("test_192_168_4_10", "test for IP 192.168.4.10")

local f_down = ProtoField.string("test_192_168_4_10.down", "Down")
local f_up = ProtoField.string("test_192_168_4_10.up", "Up")

test_192_168_4_10.fields = { f_down, f_up }

function test_192_168_4_10.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "test"
    local subtree = tree:add(test_192_168_4_10, buffer(), "test for IP 192.168.4.10")
    local offset = 0
    ...
    parsed_values['up'] = up
    do
        local min_val = 75169792
        local max_val = 535756800
...
udp_port:add(10000, test_192_168_4_10)
