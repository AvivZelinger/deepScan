-- Wireshark Lua dissector for asd on IP 192.168.4.30
-- Generated automatically from DPI JSON.

local asd_192_168_4_30 = Proto("asd_192_168_4_30", "asd for IP 192.168.4.30")

local f_checksum = ProtoField.uint32("asd_192_168_4_30.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("asd_192_168_4_30.end_flag", "End_flag")
local f_flag = ProtoField.string("asd_192_168_4_30.flag", "Flag")
local f_id = ProtoField.uint32("asd_192_168_4_30.id", "Id"), base.DEC
local f_length = ProtoField.uint32("asd_192_168_4_30.length", "Length"), base.DEC
local f_message = ProtoField.string("asd_192_168_4_30.message", "Message")

asd_192_168_4_30.fields = { f_checksum, f_end_flag, f_flag, f_id, f_length, f_message }

function asd_192_168_4_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "asd"
    local subtree = tree:add(asd_192_168_4_30, buffer(), "asd for IP 192.168.4.30")
    local offset = 0
    ...
    do
        local min_val = 86255010
        local max_val = 4140283290
...
udp_port:add(10000, asd_192_168_4_30)
