-- Wireshark Lua dissector for feb_25 on IP 192.168.5.20
-- Generated automatically from DPI JSON.

local feb_25_192_168_5_20 = Proto("feb_25_192_168_5_20", "feb_25 for IP 192.168.5.20")

local f_proto_id = ProtoField.string("feb_25_192_168_5_20.proto_id", "Proto_id")
local f_version = ProtoField.string("feb_25_192_168_5_20.version", "Version")
local f_msg_type = ProtoField.string("feb_25_192_168_5_20.msg_type", "Msg_type")
local f_session_id = ProtoField.uint32("feb_25_192_168_5_20.session_id", "Session_id"), base.DEC
local f_seq_num = ProtoField.uint32("feb_25_192_168_5_20.seq_num", "Seq_num"), base.DEC
local f_timestamp = ProtoField.string("feb_25_192_168_5_20.timestamp", "Timestamp")
local f_payload_length = ProtoField.uint32("feb_25_192_168_5_20.payload_length", "Payload_length"), base.DEC
local f_message_data = ProtoField.string("feb_25_192_168_5_20.message_data", "Message_data")

feb_25_192_168_5_20.fields = { f_proto_id, f_version, f_msg_type, f_session_id, f_seq_num, f_timestamp, f_payload_length, f_message_data }

function feb_25_192_168_5_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "feb_25"
    local subtree = tree:add(feb_25_192_168_5_20, buffer(), "feb_25 for IP 192.168.5.20")
    local offset = 0
    ...
    do
        local min_val = 1740489108936
        local max_val = 1740489108943
    ...
    if dynamic_length < 7 or dynamic_length > 11 then
...
udp_port:add(10000, feb_25_192_168_5_20)
