-- Wireshark Lua dissector for tamir6 on IP 192.168.4.40
-- This file was generated automatically from the DPI JSON description.

local tamir6_192_168_4_40 = Proto("tamir6_192_168_4_40", "tamir6 for IP 192.168.4.40")

local f_sync = ProtoField.uint8("tamir6_192_168_4_40.sync", "Sync"), base.DEC
local f_id = ProtoField.uint32("tamir6_192_168_4_40.id", "Id"), base.DEC
local f_type = ProtoField.uint32("tamir6_192_168_4_40.type", "Type"), base.DEC
local f_length = ProtoField.uint32("tamir6_192_168_4_40.length", "Length"), base.DEC
local f_payload = ProtoField.string("tamir6_192_168_4_40.payload", "Payload")
local f_crc = ProtoField.uint32("tamir6_192_168_4_40.crc", "Crc"), base.DEC
local f_flag = ProtoField.uint8("tamir6_192_168_4_40.flag", "Flag"), base.DEC

tamir6_192_168_4_40.fields = { f_sync, f_id, f_type, f_length, f_payload, f_crc, f_flag }

function tamir6_192_168_4_40.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "tamir6 (192.168.4.40)"
    local subtree = tree:add(tamir6_192_168_4_40, buffer(), "tamir6 for IP 192.168.4.40")
    local offset = 0
...
udp_port:add(10000, tamir6_192_168_4_40)
