-- Wireshark Lua dissector for aaaa on IP 192.168.4.50
-- This file was generated automatically from the DPI JSON description.

local aaaa_192_168_4_50 = Proto("aaaa_192_168_4_50", "aaaa for IP 192.168.4.50")

local f_sync = ProtoField.uint8("aaaa_192_168_4_50.sync", "Sync"), base.DEC
local f_id = ProtoField.uint32("aaaa_192_168_4_50.id", "Id"), base.DEC
local f_type = ProtoField.uint32("aaaa_192_168_4_50.type", "Type"), base.DEC
local f_length = ProtoField.uint32("aaaa_192_168_4_50.length", "Length"), base.DEC
local f_payload = ProtoField.string("aaaa_192_168_4_50.payload", "Payload")
local f_crc = ProtoField.uint32("aaaa_192_168_4_50.crc", "Crc"), base.DEC
local f_flag = ProtoField.uint8("aaaa_192_168_4_50.flag", "Flag"), base.DEC

aaaa_192_168_4_50.fields = { f_sync, f_id, f_type, f_length, f_payload, f_crc, f_flag }

function aaaa_192_168_4_50.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "aaaa (192.168.4.50)"
    local subtree = tree:add(aaaa_192_168_4_50, buffer(), "aaaa for IP 192.168.4.50")
    local offset = 0
...
udp_port:add(10000, aaaa_192_168_4_50)
