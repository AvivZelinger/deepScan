-- Wireshark Lua dissector for test3 on IP 192.168.5.20
-- Generated automatically from DPI JSON.

local test3_192_168_5_20 = Proto("test3_192_168_5_20", "test3 for IP 192.168.5.20")

local f_signature = ProtoField.string("test3_192_168_5_20.signature", "Signature")
local f_version = ProtoField.uint8("test3_192_168_5_20.version", "Version"), base.DEC
local f_flags = ProtoField.uint8("test3_192_168_5_20.flags", "Flags"), base.DEC
local f_command = ProtoField.string("test3_192_168_5_20.command", "Command")
local f_session_id = ProtoField.uint32("test3_192_168_5_20.session_id", "Session_id"), base.DEC
local f_msg_id = ProtoField.uint32("test3_192_168_5_20.msg_id", "Msg_id"), base.DEC
local f_timestamp = ProtoField.uint64("test3_192_168_5_20.timestamp", "Timestamp"), base.DEC
local f_payload_size = ProtoField.uint32("test3_192_168_5_20.payload_size", "Payload_size"), base.DEC
local f_message = ProtoField.string("test3_192_168_5_20.message", "Message")

test3_192_168_5_20.fields = { f_signature, f_version, f_flags, f_command, f_session_id, f_msg_id, f_timestamp, f_payload_size, f_message }

function test3_192_168_5_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "test3"
    local subtree = tree:add(test3_192_168_5_20, buffer(), "test3 for IP 192.168.5.20")
    local offset = 0
    ...
    do
        local min_val = 1740855245394
        local max_val = 1740855245404
    ...
    if dynamic_length < 8 or dynamic_length > 10 then
...
udp_port:add(10000, test3_192_168_5_20)
