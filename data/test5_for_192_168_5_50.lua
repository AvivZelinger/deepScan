-- Wireshark Lua dissector for test5 on IP 192.168.5.50
-- Generated automatically from DPI JSON.

local test5_192_168_5_50 = Proto("test5_192_168_5_50", "test5 for IP 192.168.5.50")

local f_signature = ProtoField.string("test5_192_168_5_50.signature", "Signature")
local f_version = ProtoField.uint8("test5_192_168_5_50.version", "Version"), base.DEC
local f_flags = ProtoField.uint8("test5_192_168_5_50.flags", "Flags"), base.DEC
local f_command = ProtoField.string("test5_192_168_5_50.command", "Command")
local f_session_id = ProtoField.uint32("test5_192_168_5_50.session_id", "Session_id"), base.DEC
local f_msg_id = ProtoField.uint32("test5_192_168_5_50.msg_id", "Msg_id"), base.DEC
local f_timestamp = ProtoField.uint64("test5_192_168_5_50.timestamp", "Timestamp"), base.DEC
local f_payload_size = ProtoField.uint32("test5_192_168_5_50.payload_size", "Payload_size"), base.DEC
local f_message = ProtoField.string("test5_192_168_5_50.message", "Message")

test5_192_168_5_50.fields = { f_signature, f_version, f_flags, f_command, f_session_id, f_msg_id, f_timestamp, f_payload_size, f_message }

function test5_192_168_5_50.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "test5"
    local subtree = tree:add(test5_192_168_5_50, buffer(), "test5 for IP 192.168.5.50")
    local offset = 0
...
udp_port:add(10000, test5_192_168_5_50)
