-- Wireshark Lua dissector for s on IP 192.168.3.30
-- This file was generated automatically from the DPI JSON description.

local s_192_168_3_30 = Proto("s_192_168_3_30", "s for IP 192.168.3.30")

local f_start_flag = ProtoField.uint8("s_192_168_3_30.start_flag", "Start_flag"), base.DEC
local f_msg_id = ProtoField.uint32("s_192_168_3_30.msg_id", "Msg_id"), base.DEC
local f_command = ProtoField.string("s_192_168_3_30.command", "Command")
local f_data_length = ProtoField.uint16("s_192_168_3_30.data_length", "Data_length"), base.DEC
local f_data = ProtoField.string("s_192_168_3_30.data", "Data")
local f_end_flag = ProtoField.uint8("s_192_168_3_30.end_flag", "End_flag"), base.DEC

s_192_168_3_30.fields = { f_start_flag, f_msg_id, f_command, f_data_length, f_data, f_end_flag }

function s_192_168_3_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "s (192.168.3.30)"
    local subtree = tree:add(s_192_168_3_30, buffer(), "s for IP 192.168.3.30")
    local offset = 0
...
udp_port:add(10000, s_192_168_3_30)
