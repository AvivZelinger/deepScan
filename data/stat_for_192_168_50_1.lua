-- Wireshark Lua dissector for stat on IP 192.168.50.1
-- Generated automatically from DPI JSON.

local stat_192_168_50_1 = Proto("stat_192_168_50_1", "stat for IP 192.168.50.1")

local f_header = ProtoField.string("stat_192_168_50_1.header", "Header")
local f_version = ProtoField.uint32("stat_192_168_50_1.version", "Version"), base.DEC
local f_flags1 = ProtoField.uint8("stat_192_168_50_1.flags1", "Flags1 (Bitfield)")
local f_flags2 = ProtoField.uint8("stat_192_168_50_1.flags2", "Flags2 (Bitfield)")
local f_temperature = ProtoField.string("stat_192_168_50_1.temperature", "Temperature")
local f_pressure = ProtoField.string("stat_192_168_50_1.pressure", "Pressure")
local f_device_id = ProtoField.string("stat_192_168_50_1.device_id", "Device_id")
local f_message_length = ProtoField.uint32("stat_192_168_50_1.message_length", "Message_length"), base.DEC
local f_message = ProtoField.string("stat_192_168_50_1.message", "Message")
local f_checksum = ProtoField.uint32("stat_192_168_50_1.checksum", "Checksum"), base.DEC

stat_192_168_50_1.fields = { f_header, f_version, f_flags1, f_flags2, f_temperature, f_pressure, f_device_id, f_message_length, f_message, f_checksum }

function stat_192_168_50_1.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "stat"
    local subtree = tree:add(stat_192_168_50_1, buffer(), "stat for IP 192.168.50.1")
    local offset = 0
    ...
    do
        local min_val = 276530363.0
        local max_val = 4109898148.0
...
udp_port:add(10000, stat_192_168_50_1)
