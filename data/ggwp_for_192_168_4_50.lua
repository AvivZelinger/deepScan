-- Wireshark Lua dissector for ggwp on IP 192.168.4.50
-- Generated automatically from DPI JSON.

local ggwp_192_168_4_50 = Proto("ggwp_192_168_4_50", "ggwp for IP 192.168.4.50")

local f_checksum = ProtoField.uint32("ggwp_192_168_4_50.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("ggwp_192_168_4_50.end_flag", "End_flag")
local f_flag = ProtoField.string("ggwp_192_168_4_50.flag", "Flag")
local f_id = ProtoField.uint32("ggwp_192_168_4_50.id", "Id"), base.DEC
local f_length = ProtoField.uint32("ggwp_192_168_4_50.length", "Length"), base.DEC
local f_message = ProtoField.string("ggwp_192_168_4_50.message", "Message")

ggwp_192_168_4_50.fields = { f_checksum, f_end_flag, f_flag, f_id, f_length, f_message }

function ggwp_192_168_4_50.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "ggwp"
    local subtree = tree:add(ggwp_192_168_4_50, buffer(), "ggwp for IP 192.168.4.50")
    local offset = 0
    ...
    do
        local min_val = 65282756
        local max_val = 3987166796
...
udp_port:add(10000, ggwp_192_168_4_50)
