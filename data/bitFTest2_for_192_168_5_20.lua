-- Wireshark Lua dissector for bitFTest2 on IP 192.168.5.20
-- Generated automatically from DPI JSON.

local bitFTest2_192_168_5_20 = Proto("bitFTest2_192_168_5_20", "bitFTest2 for IP 192.168.5.20")

local f_signature = ProtoField.string("bitFTest2_192_168_5_20.signature", "Signature")
local f_version = ProtoField.uint8("bitFTest2_192_168_5_20.version", "Version"), base.DEC
local f_flags = ProtoField.uint8("bitFTest2_192_168_5_20.flags", "Flags"), base.DEC
local f_flags_bf0 = ProtoField.uint8("bitFTest2_192_168_5_20.flags_bf0", "Flags Bitfield 1", base.DEC)
local bf_fields_flags = { f_flags_bf0 }
local f_command = ProtoField.string("bitFTest2_192_168_5_20.command", "Command")
local f_session_id = ProtoField.uint32("bitFTest2_192_168_5_20.session_id", "Session_id"), base.DEC
local f_msg_id = ProtoField.uint32("bitFTest2_192_168_5_20.msg_id", "Msg_id"), base.DEC
local f_timestamp = ProtoField.uint64("bitFTest2_192_168_5_20.timestamp", "Timestamp"), base.DEC
local f_payload_size = ProtoField.uint32("bitFTest2_192_168_5_20.payload_size", "Payload_size"), base.DEC
local f_message = ProtoField.string("bitFTest2_192_168_5_20.message", "Message")

bitFTest2_192_168_5_20.fields = { f_signature, f_version, f_flags, f_flags_bf0, f_command, f_session_id, f_msg_id, f_timestamp, f_payload_size, f_message }

function bitFTest2_192_168_5_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "bitFTest2"
    local subtree = tree:add(bitFTest2_192_168_5_20, buffer(), "bitFTest2 for IP 192.168.5.20")
    local offset = 0
...
udp_port:add(10000, bitFTest2_192_168_5_20)
