-- Wireshark Lua dissector for testtttt4 on IP 192.168.5.10
-- Generated automatically from DPI JSON.

local testtttt4_192_168_5_10 = Proto("testtttt4_192_168_5_10", "testtttt4 for IP 192.168.5.10")

local f_signature = ProtoField.string("testtttt4_192_168_5_10.signature", "Signature")
local f_version = ProtoField.uint8("testtttt4_192_168_5_10.version", "Version"), base.DEC
local f_flags = ProtoField.uint8("testtttt4_192_168_5_10.flags", "Flags"), base.DEC
local f_command = ProtoField.string("testtttt4_192_168_5_10.command", "Command")
local f_session_id = ProtoField.uint32("testtttt4_192_168_5_10.session_id", "Session_id"), base.DEC
local f_msg_id = ProtoField.uint32("testtttt4_192_168_5_10.msg_id", "Msg_id"), base.DEC
local f_timestamp = ProtoField.uint64("testtttt4_192_168_5_10.timestamp", "Timestamp"), base.DEC
local f_payload_size = ProtoField.uint32("testtttt4_192_168_5_10.payload_size", "Payload_size"), base.DEC
local f_message = ProtoField.string("testtttt4_192_168_5_10.message", "Message")

testtttt4_192_168_5_10.fields = { f_signature, f_version, f_flags, f_command, f_session_id, f_msg_id, f_timestamp, f_payload_size, f_message }

function testtttt4_192_168_5_10.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "testtttt4"
    local subtree = tree:add(testtttt4_192_168_5_10, buffer(), "testtttt4 for IP 192.168.5.10")
    local offset = 0
...
udp_port:add(10000, testtttt4_192_168_5_10)
