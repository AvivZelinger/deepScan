-- Wireshark Lua dissector for sss on IP 192.168.3.20
-- This file was generated automatically from the DPI JSON description.

local sss_192_168_3_20 = Proto("sss_192_168_3_20", "sss for IP 192.168.3.20")

local f_sync = ProtoField.uint8("sss_192_168_3_20.sync", "Sync"), base.DEC
local f_id = ProtoField.uint32("sss_192_168_3_20.id", "Id"), base.DEC
local f_type = ProtoField.uint32("sss_192_168_3_20.type", "Type"), base.DEC
local f_length = ProtoField.uint32("sss_192_168_3_20.length", "Length"), base.DEC
local f_payload = ProtoField.string("sss_192_168_3_20.payload", "Payload")
local f_crc = ProtoField.uint32("sss_192_168_3_20.crc", "Crc"), base.DEC
local f_flag = ProtoField.uint8("sss_192_168_3_20.flag", "Flag"), base.DEC

sss_192_168_3_20.fields = { f_sync, f_id, f_type, f_length, f_payload, f_crc, f_flag }

function sss_192_168_3_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "sss (192.168.3.20)"
    local subtree = tree:add(sss_192_168_3_20, buffer(), "sss for IP 192.168.3.20")
    local offset = 0
    ...
    if dynamic_length < -2 or dynamic_length > 17 then
    ...
    if crc < 54684282 or crc > 2018859354 then
...
udp_port:add(10000, sss_192_168_3_20)
