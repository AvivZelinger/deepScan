-- Wireshark Lua dissector for s on IP 192.168.2.30
-- This file was generated automatically from the DPI JSON description.

local s_192_168_2_30 = Proto("s_192_168_2_30", "s for IP 192.168.2.30")

local f_header = ProtoField.string("s_192_168_2_30.header", "Header")
local f_version = ProtoField.uint8("s_192_168_2_30.version", "Version"), base.DEC
local f_msg_type = ProtoField.string("s_192_168_2_30.msg_type", "Msg_type")
local f_seq = ProtoField.uint32("s_192_168_2_30.seq", "Seq"), base.DEC
local f_payload_size = ProtoField.uint16("s_192_168_2_30.payload_size", "Payload_size"), base.DEC
local f_payload = ProtoField.string("s_192_168_2_30.payload", "Payload")
local f_timestamp = ProtoField.uint32("s_192_168_2_30.timestamp", "Timestamp"), base.DEC
local f_source = ProtoField.string("s_192_168_2_30.source", "Source")
local f_destination = ProtoField.string("s_192_168_2_30.destination", "Destination")
local f_checksum = ProtoField.uint32("s_192_168_2_30.checksum", "Checksum"), base.DEC

s_192_168_2_30.fields = { f_header, f_version, f_msg_type, f_seq, f_payload_size, f_payload, f_timestamp, f_source, f_destination, f_checksum }

function s_192_168_2_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "s (192.168.2.30)"
    local subtree = tree:add(s_192_168_2_30, buffer(), "s for IP 192.168.2.30")
    local offset = 0
    ...
    if header < 138 or header > 997 then
    ...
    if payload_size < 5 or payload_size > 19 then
    ...
    if dynamic_length < -10 or dynamic_length > 4 then
    ...
    if timestamp < 4.2095005868317505e-42 or timestamp > 2.2853558839651998e+32 then
    ...
    if checksum < 2289 or checksum > 65261 then
...
udp_port:add(10000, s_192_168_2_30)
