-- Wireshark Lua dissector for stat on IP 192.168.50.2
-- Generated automatically from DPI JSON.

local stat_192_168_50_2 = Proto("stat_192_168_50_2", "stat for IP 192.168.50.2")

local f_header = ProtoField.string("stat_192_168_50_2.header", "Header")
local f_version = ProtoField.uint32("stat_192_168_50_2.version", "Version"), base.DEC
local f_flags1 = ProtoField.uint8("stat_192_168_50_2.flags1", "Flags1 (Bitfield)")
local f_flags2 = ProtoField.uint8("stat_192_168_50_2.flags2", "Flags2 (Bitfield)")
local f_temperature = ProtoField.string("stat_192_168_50_2.temperature", "Temperature")
local f_pressure = ProtoField.string("stat_192_168_50_2.pressure", "Pressure")
local f_device_id = ProtoField.string("stat_192_168_50_2.device_id", "Device_id")
local f_message_length = ProtoField.uint32("stat_192_168_50_2.message_length", "Message_length"), base.DEC
local f_message = ProtoField.string("stat_192_168_50_2.message", "Message")
local f_checksum = ProtoField.uint32("stat_192_168_50_2.checksum", "Checksum"), base.DEC

stat_192_168_50_2.fields = { f_header, f_version, f_flags1, f_flags2, f_temperature, f_pressure, f_device_id, f_message_length, f_message, f_checksum }

function stat_192_168_50_2.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "stat"
    local subtree = tree:add(stat_192_168_50_2, buffer(), "stat for IP 192.168.50.2")
    local offset = 0
    ...
    do
        local min_val = 170559973.0
        local max_val = 3857783110.0
...
udp_port:add(10000, stat_192_168_50_2)
