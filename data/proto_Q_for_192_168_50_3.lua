-- Wireshark Lua dissector for proto_Q on IP 192.168.50.3
-- Generated automatically from DPI JSON.

local proto_Q_192_168_50_3 = Proto("proto_Q_192_168_50_3", "proto_Q for IP 192.168.50.3")

local f_header = ProtoField.string("proto_Q_192_168_50_3.header", "Header")
local f_version = ProtoField.uint32("proto_Q_192_168_50_3.version", "Version"), base.DEC
local f_flags1 = ProtoField.uint8("proto_Q_192_168_50_3.flags1", "Flags1 (Bitfield)")
local f_flags2 = ProtoField.uint8("proto_Q_192_168_50_3.flags2", "Flags2 (Bitfield)")
local f_temperature = ProtoField.uint32("proto_Q_192_168_50_3.temperature", "Temperature"), base.DEC
local f_pressure = ProtoField.string("proto_Q_192_168_50_3.pressure", "Pressure")
local f_device_id = ProtoField.string("proto_Q_192_168_50_3.device_id", "Device_id")
local f_message_length = ProtoField.uint32("proto_Q_192_168_50_3.message_length", "Message_length"), base.DEC
local f_message = ProtoField.string("proto_Q_192_168_50_3.message", "Message")
local f_checksum = ProtoField.uint32("proto_Q_192_168_50_3.checksum", "Checksum"), base.DEC

proto_Q_192_168_50_3.fields = { f_header, f_version, f_flags1, f_flags2, f_temperature, f_pressure, f_device_id, f_message_length, f_message, f_checksum }

function proto_Q_192_168_50_3.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "proto_Q"
    local subtree = tree:add(proto_Q_192_168_50_3, buffer(), "proto_Q for IP 192.168.50.3")
    local offset = 0
    ...
    do
        local min_val = -48.995418548583984
        local max_val = 143.9222412109375
    ...
    do
        local min_val = 379480904
        local max_val = 3769158108
...
udp_port:add(10000, proto_Q_192_168_50_3)
