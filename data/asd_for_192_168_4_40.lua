-- Wireshark Lua dissector for asd on IP 192.168.4.40
-- Generated automatically from DPI JSON.

local asd_192_168_4_40 = Proto("asd_192_168_4_40", "asd for IP 192.168.4.40")

local f_checksum = ProtoField.uint32("asd_192_168_4_40.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("asd_192_168_4_40.end_flag", "End_flag")
local f_flag = ProtoField.string("asd_192_168_4_40.flag", "Flag")
local f_id = ProtoField.uint32("asd_192_168_4_40.id", "Id"), base.DEC
local f_length = ProtoField.uint32("asd_192_168_4_40.length", "Length"), base.DEC
local f_message = ProtoField.string("asd_192_168_4_40.message", "Message")

asd_192_168_4_40.fields = { f_checksum, f_end_flag, f_flag, f_id, f_length, f_message }

function asd_192_168_4_40.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "asd"
    local subtree = tree:add(asd_192_168_4_40, buffer(), "asd for IP 192.168.4.40")
    local offset = 0
    ...
    do
        local min_val = 115045099
        local max_val = 4101309716
...
udp_port:add(10000, asd_192_168_4_40)
