-- Wireshark Lua dissector for Protocol_For_Nili on IP 192.168.3.50
-- This file was generated automatically from the DPI JSON description.

local Protocol_For_Nili_192_168_3_50 = Proto("Protocol_For_Nili_192_168_3_50", "Protocol_For_Nili for IP 192.168.3.50")

local f_start_flag = ProtoField.uint8("Protocol_For_Nili_192_168_3_50.start_flag", "Start_flag"), base.DEC
local f_msg_id = ProtoField.uint32("Protocol_For_Nili_192_168_3_50.msg_id", "Msg_id"), base.DEC
local f_command = ProtoField.string("Protocol_For_Nili_192_168_3_50.command", "Command")
local f_data_length = ProtoField.uint16("Protocol_For_Nili_192_168_3_50.data_length", "Data_length"), base.DEC
local f_data = ProtoField.string("Protocol_For_Nili_192_168_3_50.data", "Data")
local f_end_flag = ProtoField.uint8("Protocol_For_Nili_192_168_3_50.end_flag", "End_flag"), base.DEC

Protocol_For_Nili_192_168_3_50.fields = { f_start_flag, f_msg_id, f_command, f_data_length, f_data, f_end_flag }

function Protocol_For_Nili_192_168_3_50.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "Protocol_For_Nili (192.168.3.50)"
    local subtree = tree:add(Protocol_For_Nili_192_168_3_50, buffer(), "Protocol_For_Nili for IP 192.168.3.50")
    local offset = 0
    ...
    if msg_id < 1597 or msg_id > 9146 then
    ...
    if data_length < 1 or data_length > 15 then
    ...
    if dynamic_length < 1 or dynamic_length > 15 then
...
udp_port:add(10000, Protocol_For_Nili_192_168_3_50)
