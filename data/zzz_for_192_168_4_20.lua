-- Wireshark Lua dissector for zzz on IP 192.168.4.20
-- This file was generated automatically from the DPI JSON description.

local zzz_192_168_4_20 = Proto("zzz_192_168_4_20", "zzz for IP 192.168.4.20")

local f_sync = ProtoField.uint8("zzz_192_168_4_20.sync", "Sync"), base.DEC
local f_id = ProtoField.uint32("zzz_192_168_4_20.id", "Id"), base.DEC
local f_type = ProtoField.uint32("zzz_192_168_4_20.type", "Type"), base.DEC
local f_length = ProtoField.uint32("zzz_192_168_4_20.length", "Length"), base.DEC
local f_payload = ProtoField.string("zzz_192_168_4_20.payload", "Payload")
local f_crc = ProtoField.uint32("zzz_192_168_4_20.crc", "Crc"), base.DEC
local f_flag = ProtoField.uint8("zzz_192_168_4_20.flag", "Flag"), base.DEC

zzz_192_168_4_20.fields = { f_sync, f_id, f_type, f_length, f_payload, f_crc, f_flag }

function zzz_192_168_4_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "zzz (192.168.4.20)"
    local subtree = tree:add(zzz_192_168_4_20, buffer(), "zzz for IP 192.168.4.20")
    local offset = 0
...
udp_port:add(10000, zzz_192_168_4_20)
