-- Wireshark Lua dissector for koby on IP 192.168.4.10
-- This file was generated automatically from the DPI JSON description.

local koby_192_168_4_10 = Proto("koby_192_168_4_10", "koby for IP 192.168.4.10")

local f_sync = ProtoField.uint8("koby_192_168_4_10.sync", "Sync"), base.DEC
local f_id = ProtoField.uint32("koby_192_168_4_10.id", "Id"), base.DEC
local f_type = ProtoField.uint32("koby_192_168_4_10.type", "Type"), base.DEC
local f_length = ProtoField.uint32("koby_192_168_4_10.length", "Length"), base.DEC
local f_payload = ProtoField.string("koby_192_168_4_10.payload", "Payload")
local f_crc = ProtoField.uint32("koby_192_168_4_10.crc", "Crc"), base.DEC
local f_flag = ProtoField.uint8("koby_192_168_4_10.flag", "Flag"), base.DEC

koby_192_168_4_10.fields = { f_sync, f_id, f_type, f_length, f_payload, f_crc, f_flag }

function koby_192_168_4_10.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "koby (192.168.4.10)"
    local subtree = tree:add(koby_192_168_4_10, buffer(), "koby for IP 192.168.4.10")
    local offset = 0
...
udp_port:add(10000, koby_192_168_4_10)
