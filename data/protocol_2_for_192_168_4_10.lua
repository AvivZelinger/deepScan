-- Wireshark Lua dissector for protocol_2 on IP 192.168.4.10
-- Generated automatically from DPI JSON.

local protocol_2_192_168_4_10 = Proto("protocol_2_192_168_4_10", "protocol_2 for IP 192.168.4.10")

local f_checksum = ProtoField.uint32("protocol_2_192_168_4_10.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("protocol_2_192_168_4_10.end_flag", "End_flag")
local f_id = ProtoField.uint32("protocol_2_192_168_4_10.id", "Id"), base.DEC
local f_length = ProtoField.uint32("protocol_2_192_168_4_10.length", "Length"), base.DEC

protocol_2_192_168_4_10.fields = { f_checksum, f_end_flag, f_id, f_length }

function protocol_2_192_168_4_10.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "protocol_2"
    local subtree = tree:add(protocol_2_192_168_4_10, buffer(), "protocol_2 for IP 192.168.4.10")
    local offset = 0
    ...
    do
        local min_val = 90598709
        local max_val = 255289393
...
udp_port:add(10000, protocol_2_192_168_4_10)
