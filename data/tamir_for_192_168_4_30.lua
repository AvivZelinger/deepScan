-- Wireshark Lua dissector for tamir on IP 192.168.4.30
-- This file was generated automatically from the DPI JSON description.

local tamir_192_168_4_30 = Proto("tamir_192_168_4_30", "tamir for IP 192.168.4.30")

local f_sync = ProtoField.uint8("tamir_192_168_4_30.sync", "Sync"), base.DEC
local f_id = ProtoField.uint32("tamir_192_168_4_30.id", "Id"), base.DEC
local f_type = ProtoField.uint32("tamir_192_168_4_30.type", "Type"), base.DEC
local f_length = ProtoField.uint32("tamir_192_168_4_30.length", "Length"), base.DEC
local f_payload = ProtoField.string("tamir_192_168_4_30.payload", "Payload")
local f_crc = ProtoField.uint32("tamir_192_168_4_30.crc", "Crc"), base.DEC
local f_flag = ProtoField.uint8("tamir_192_168_4_30.flag", "Flag"), base.DEC

tamir_192_168_4_30.fields = { f_sync, f_id, f_type, f_length, f_payload, f_crc, f_flag }

function tamir_192_168_4_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "tamir (192.168.4.30)"
    local info_text = string.format("%s(%s) DPI", "tamir", "192.168.4.30")
    local subtree = tree:add(tamir_192_168_4_30, buffer(), "tamir for IP 192.168.4.30")
    local offset = 0
...
udp_port:add(10000, tamir_192_168_4_30)
