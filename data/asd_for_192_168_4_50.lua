-- Wireshark Lua dissector for asd on IP 192.168.4.50
-- Generated automatically from DPI JSON.

local asd_192_168_4_50 = Proto("asd_192_168_4_50", "asd for IP 192.168.4.50")

local f_checksum = ProtoField.uint32("asd_192_168_4_50.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("asd_192_168_4_50.end_flag", "End_flag")
local f_flag = ProtoField.string("asd_192_168_4_50.flag", "Flag")
local f_id = ProtoField.uint32("asd_192_168_4_50.id", "Id"), base.DEC
local f_length = ProtoField.uint32("asd_192_168_4_50.length", "Length"), base.DEC
local f_message = ProtoField.string("asd_192_168_4_50.message", "Message")

asd_192_168_4_50.fields = { f_checksum, f_end_flag, f_flag, f_id, f_length, f_message }

function asd_192_168_4_50.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "asd"
    local subtree = tree:add(asd_192_168_4_50, buffer(), "asd for IP 192.168.4.50")
    local offset = 0
    ...
    do
        local min_val = 280928825
        local max_val = 4208399043
...
udp_port:add(10000, asd_192_168_4_50)
