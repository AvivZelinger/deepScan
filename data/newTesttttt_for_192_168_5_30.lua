-- Wireshark Lua dissector for newTesttttt on IP 192.168.5.30
-- Generated automatically from DPI JSON.

local newTesttttt_192_168_5_30 = Proto("newTesttttt_192_168_5_30", "newTesttttt for IP 192.168.5.30")

local f_signature = ProtoField.string("newTesttttt_192_168_5_30.signature", "Signature")
local f_version = ProtoField.uint8("newTesttttt_192_168_5_30.version", "Version"), base.DEC
local f_flags = ProtoField.uint8("newTesttttt_192_168_5_30.flags", "Flags"), base.DEC
local f_flags_bf0 = ProtoField.uint8("newTesttttt_192_168_5_30.flags_bf0", "Flags Bitfield 1", base.DEC)
local f_flags_bf1 = ProtoField.uint8("newTesttttt_192_168_5_30.flags_bf1", "Flags Bitfield 2", base.DEC)
local bf_fields_flags = { f_flags_bf0, f_flags_bf1 }
local f_command = ProtoField.string("newTesttttt_192_168_5_30.command", "Command")
local f_session_id = ProtoField.uint32("newTesttttt_192_168_5_30.session_id", "Session_id"), base.DEC
local f_msg_id = ProtoField.uint32("newTesttttt_192_168_5_30.msg_id", "Msg_id"), base.DEC
local f_timestamp = ProtoField.uint64("newTesttttt_192_168_5_30.timestamp", "Timestamp"), base.DEC
local f_payload_size = ProtoField.uint32("newTesttttt_192_168_5_30.payload_size", "Payload_size"), base.DEC
local f_message = ProtoField.string("newTesttttt_192_168_5_30.message", "Message")

newTesttttt_192_168_5_30.fields = { f_signature, f_version, f_flags, f_flags_bf0, f_flags_bf1, f_command, f_session_id, f_msg_id, f_timestamp, f_payload_size, f_message }

function newTesttttt_192_168_5_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "newTesttttt"
    local subtree = tree:add(newTesttttt_192_168_5_30, buffer(), "newTesttttt for IP 192.168.5.30")
    local offset = 0
    ...
    do
        local bits_per_field = (1 * 8) / 2
        for i = 0, 2 - 1 do
            local shift = ((2 - 1 - i) * bits_per_field)
...
udp_port:add(10000, newTesttttt_192_168_5_30)
