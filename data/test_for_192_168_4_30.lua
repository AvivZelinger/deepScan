-- Wireshark Lua dissector for test on IP 192.168.4.30
-- Generated automatically from DPI JSON.

local test_192_168_4_30 = Proto("test_192_168_4_30", "test for IP 192.168.4.30")

local f_down = ProtoField.string("test_192_168_4_30.down", "Down")
local f_up = ProtoField.string("test_192_168_4_30.up", "Up")

test_192_168_4_30.fields = { f_down, f_up }

function test_192_168_4_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "test"
    local subtree = tree:add(test_192_168_4_30, buffer(), "test for IP 192.168.4.30")
    local offset = 0
    ...
    parsed_values['up'] = up
    do
        local min_val = 74121216
        local max_val = 600834048
...
udp_port:add(10000, test_192_168_4_30)
