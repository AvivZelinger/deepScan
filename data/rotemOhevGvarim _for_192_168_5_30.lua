-- Wireshark Lua dissector for rotemOhevGvarim  on IP 192.168.5.30
-- Generated automatically from DPI JSON.

local rotemOhevGvarim _192_168_5_30 = Proto("rotemOhevGvarim _192_168_5_30", "rotemOhevGvarim  for IP 192.168.5.30")

local f_proto_id = ProtoField.string("rotemOhevGvarim _192_168_5_30.proto_id", "Proto_id")
local f_version = ProtoField.uint8("rotemOhevGvarim _192_168_5_30.version", "Version"), base.DEC
local f_msg_type = ProtoField.string("rotemOhevGvarim _192_168_5_30.msg_type", "Msg_type")
local f_session_id = ProtoField.uint32("rotemOhevGvarim _192_168_5_30.session_id", "Session_id"), base.DEC
local f_seq_num = ProtoField.uint32("rotemOhevGvarim _192_168_5_30.seq_num", "Seq_num"), base.DEC
local f_timestamp = ProtoField.uint64("rotemOhevGvarim _192_168_5_30.timestamp", "Timestamp"), base.DEC
local f_payload_length = ProtoField.uint32("rotemOhevGvarim _192_168_5_30.payload_length", "Payload_length"), base.DEC
local f_message_data = ProtoField.string("rotemOhevGvarim _192_168_5_30.message_data", "Message_data")

rotemOhevGvarim _192_168_5_30.fields = { f_proto_id, f_version, f_msg_type, f_session_id, f_seq_num, f_timestamp, f_payload_length, f_message_data }

function rotemOhevGvarim _192_168_5_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "rotemOhevGvarim "
    local subtree = tree:add(rotemOhevGvarim _192_168_5_30, buffer(), "rotemOhevGvarim  for IP 192.168.5.30")
    local offset = 0
    ...
    do
        local min_val = 1740589396031
        local max_val = 1740589396116
...
udp_port:add(10000, rotemOhevGvarim _192_168_5_30)
