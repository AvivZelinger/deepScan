-- Wireshark Lua dissector for Protocol_For_Nili on IP 192.168.3.20
-- This file was generated automatically from the DPI JSON description.

local Protocol_For_Nili_192_168_3_20 = Proto("Protocol_For_Nili_192_168_3_20", "Protocol_For_Nili for IP 192.168.3.20")

local f_start_flag = ProtoField.uint8("Protocol_For_Nili_192_168_3_20.start_flag", "Start_flag"), base.DEC
local f_msg_id = ProtoField.uint32("Protocol_For_Nili_192_168_3_20.msg_id", "Msg_id"), base.DEC
local f_command = ProtoField.string("Protocol_For_Nili_192_168_3_20.command", "Command")
local f_data_length = ProtoField.uint16("Protocol_For_Nili_192_168_3_20.data_length", "Data_length"), base.DEC
local f_data = ProtoField.string("Protocol_For_Nili_192_168_3_20.data", "Data")
local f_end_flag = ProtoField.uint8("Protocol_For_Nili_192_168_3_20.end_flag", "End_flag"), base.DEC

Protocol_For_Nili_192_168_3_20.fields = { f_start_flag, f_msg_id, f_command, f_data_length, f_data, f_end_flag }

function Protocol_For_Nili_192_168_3_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "Protocol_For_Nili (192.168.3.20)"
    local subtree = tree:add(Protocol_For_Nili_192_168_3_20, buffer(), "Protocol_For_Nili for IP 192.168.3.20")
    local offset = 0
...
udp_port:add(10000, Protocol_For_Nili_192_168_3_20)
