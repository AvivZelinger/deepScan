-- Wireshark Lua dissector for aaaa on IP 192.168.3.20
-- This file was generated automatically from the DPI JSON description.

local aaaa_192_168_3_20 = Proto("aaaa_192_168_3_20", "aaaa for IP 192.168.3.20")

local f_start_flag = ProtoField.uint8("aaaa_192_168_3_20.start_flag", "Start_flag"), base.DEC
local f_msg_id = ProtoField.uint32("aaaa_192_168_3_20.msg_id", "Msg_id"), base.DEC
local f_command = ProtoField.string("aaaa_192_168_3_20.command", "Command")
local f_data_length = ProtoField.uint16("aaaa_192_168_3_20.data_length", "Data_length"), base.DEC
local f_data = ProtoField.string("aaaa_192_168_3_20.data", "Data")
local f_end_flag = ProtoField.uint8("aaaa_192_168_3_20.end_flag", "End_flag"), base.DEC

aaaa_192_168_3_20.fields = { f_start_flag, f_msg_id, f_command, f_data_length, f_data, f_end_flag }

function aaaa_192_168_3_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "aaaa (192.168.3.20)"
    local subtree = tree:add(aaaa_192_168_3_20, buffer(), "aaaa for IP 192.168.3.20")
    local offset = 0
...
udp_port:add(10000, aaaa_192_168_3_20)
