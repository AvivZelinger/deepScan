-- Wireshark Lua dissector for aviv zli on IP 192.168.4.30
-- This file was generated automatically from the DPI JSON description.

local aviv zli_192_168_4_30 = Proto("aviv zli_192_168_4_30", "aviv zli for IP 192.168.4.30")

local f_checksum = ProtoField.uint32("aviv zli_192_168_4_30.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("aviv zli_192_168_4_30.end_flag", "End_flag")
local f_flag = ProtoField.string("aviv zli_192_168_4_30.flag", "Flag")
local f_id = ProtoField.uint32("aviv zli_192_168_4_30.id", "Id"), base.DEC
local f_length = ProtoField.uint32("aviv zli_192_168_4_30.length", "Length"), base.DEC
local f_message = ProtoField.string("aviv zli_192_168_4_30.message", "Message")

aviv zli_192_168_4_30.fields = { f_checksum, f_end_flag, f_flag, f_id, f_length, f_message }

function aviv zli_192_168_4_30.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "aviv zli (192.168.4.30)"
    local subtree = tree:add(aviv zli_192_168_4_30, buffer(), "aviv zli for IP 192.168.4.30")
    local offset = 0
    ...
    if checksum < 86255010 or checksum > 4140283290 then
...
udp_port:add(10000, aviv zli_192_168_4_30)
