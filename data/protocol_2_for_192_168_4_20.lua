-- Wireshark Lua dissector for protocol_2 on IP 192.168.4.20
-- Generated automatically from DPI JSON.

local protocol_2_192_168_4_20 = Proto("protocol_2_192_168_4_20", "protocol_2 for IP 192.168.4.20")

local f_checksum = ProtoField.uint32("protocol_2_192_168_4_20.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("protocol_2_192_168_4_20.end_flag", "End_flag")
local f_id = ProtoField.uint32("protocol_2_192_168_4_20.id", "Id"), base.DEC
local f_length = ProtoField.uint32("protocol_2_192_168_4_20.length", "Length"), base.DEC

protocol_2_192_168_4_20.fields = { f_checksum, f_end_flag, f_id, f_length }

function protocol_2_192_168_4_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "protocol_2"
    local subtree = tree:add(protocol_2_192_168_4_20, buffer(), "protocol_2 for IP 192.168.4.20")
    local offset = 0
    ...
    parsed_values['id'] = id
    do
        local min_val = 100663296
        local max_val = 3925868544
    ...
    do
        local min_val = 91572802
        local max_val = 255943472
...
udp_port:add(10000, protocol_2_192_168_4_20)
