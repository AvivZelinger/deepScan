-- Wireshark Lua dissector for s on IP 192.168.2.50
-- This file was generated automatically from the DPI JSON description.

local s_192_168_2_50 = Proto("s_192_168_2_50", "s for IP 192.168.2.50")

local f_header = ProtoField.string("s_192_168_2_50.header", "Header")
local f_version = ProtoField.uint8("s_192_168_2_50.version", "Version"), base.DEC
local f_msg_type = ProtoField.string("s_192_168_2_50.msg_type", "Msg_type")
local f_seq = ProtoField.uint32("s_192_168_2_50.seq", "Seq"), base.DEC
local f_payload_size = ProtoField.uint16("s_192_168_2_50.payload_size", "Payload_size"), base.DEC
local f_payload = ProtoField.string("s_192_168_2_50.payload", "Payload")
local f_timestamp = ProtoField.uint32("s_192_168_2_50.timestamp", "Timestamp"), base.DEC
local f_source = ProtoField.string("s_192_168_2_50.source", "Source")
local f_destination = ProtoField.string("s_192_168_2_50.destination", "Destination")
local f_checksum = ProtoField.uint32("s_192_168_2_50.checksum", "Checksum"), base.DEC

s_192_168_2_50.fields = { f_header, f_version, f_msg_type, f_seq, f_payload_size, f_payload, f_timestamp, f_source, f_destination, f_checksum }

function s_192_168_2_50.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "s (192.168.2.50)"
    local subtree = tree:add(s_192_168_2_50, buffer(), "s for IP 192.168.2.50")
    local offset = 0
    ...
    if header < 125 or header > 970 then
    ...
    if payload_size < 5 or payload_size > 18 then
    ...
    if dynamic_length < -10 or dynamic_length > 3 then
    ...
    if timestamp < -2.362072139411275e+21 or timestamp > 2.0225152400954643e+34 then
    ...
    if checksum < 733 or checksum > 65391 then
...
udp_port:add(10000, s_192_168_2_50)
