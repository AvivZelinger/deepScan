-- Wireshark Lua dissector for protocol_2 on IP 192.168.4.40
-- Generated automatically from DPI JSON.

local protocol_2_192_168_4_40 = Proto("protocol_2_192_168_4_40", "protocol_2 for IP 192.168.4.40")

local f_checksum = ProtoField.uint32("protocol_2_192_168_4_40.checksum", "Checksum"), base.DEC
local f_end_flag = ProtoField.string("protocol_2_192_168_4_40.end_flag", "End_flag")
local f_id = ProtoField.uint32("protocol_2_192_168_4_40.id", "Id"), base.DEC
local f_length = ProtoField.uint32("protocol_2_192_168_4_40.length", "Length"), base.DEC

protocol_2_192_168_4_40.fields = { f_checksum, f_end_flag, f_id, f_length }

function protocol_2_192_168_4_40.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "protocol_2"
    local subtree = tree:add(protocol_2_192_168_4_40, buffer(), "protocol_2 for IP 192.168.4.40")
    local offset = 0
    ...
    do
        local min_val = 87444052
        local max_val = 257569385
...
udp_port:add(10000, protocol_2_192_168_4_40)
