-- Wireshark Lua dissector for s on IP 192.168.2.20
-- This file was generated automatically from the DPI JSON description.

local s_192_168_2_20 = Proto("s_192_168_2_20", "s for IP 192.168.2.20")

local f_header = ProtoField.string("s_192_168_2_20.header", "Header")
local f_version = ProtoField.uint8("s_192_168_2_20.version", "Version"), base.DEC
local f_msg_type = ProtoField.string("s_192_168_2_20.msg_type", "Msg_type")
local f_seq = ProtoField.uint32("s_192_168_2_20.seq", "Seq"), base.DEC
local f_payload_size = ProtoField.uint16("s_192_168_2_20.payload_size", "Payload_size"), base.DEC
local f_payload = ProtoField.string("s_192_168_2_20.payload", "Payload")
local f_timestamp = ProtoField.uint32("s_192_168_2_20.timestamp", "Timestamp"), base.DEC
local f_source = ProtoField.string("s_192_168_2_20.source", "Source")
local f_destination = ProtoField.string("s_192_168_2_20.destination", "Destination")
local f_checksum = ProtoField.uint32("s_192_168_2_20.checksum", "Checksum"), base.DEC

s_192_168_2_20.fields = { f_header, f_version, f_msg_type, f_seq, f_payload_size, f_payload, f_timestamp, f_source, f_destination, f_checksum }

function s_192_168_2_20.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "s (192.168.2.20)"
    local subtree = tree:add(s_192_168_2_20, buffer(), "s for IP 192.168.2.20")
    local offset = 0
    ...
    if header < 104 or header > 960 then
    ...
    if payload_size < 6 or payload_size > 18 then
    ...
    if dynamic_length < -9 or dynamic_length > 3 then
    ...
    if timestamp < -6.313285626401964e-30 or timestamp > 1.6074440165031936e+16 then
    ...
    if checksum < 2997 or checksum > 60249 then
...
udp_port:add(10000, s_192_168_2_20)
