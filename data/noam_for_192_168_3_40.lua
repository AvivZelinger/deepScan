-- Wireshark Lua dissector for noam on IP 192.168.3.40
-- This file was generated automatically from the DPI JSON description.

local noam_192_168_3_40 = Proto("noam_192_168_3_40", "noam for IP 192.168.3.40")

local f_start_flag = ProtoField.uint8("noam_192_168_3_40.start_flag", "Start_flag"), base.DEC
local f_msg_id = ProtoField.uint32("noam_192_168_3_40.msg_id", "Msg_id"), base.DEC
local f_command = ProtoField.string("noam_192_168_3_40.command", "Command")
local f_data_length = ProtoField.uint16("noam_192_168_3_40.data_length", "Data_length"), base.DEC
local f_data = ProtoField.string("noam_192_168_3_40.data", "Data")
local f_end_flag = ProtoField.uint8("noam_192_168_3_40.end_flag", "End_flag"), base.DEC

noam_192_168_3_40.fields = { f_start_flag, f_msg_id, f_command, f_data_length, f_data, f_end_flag }

function noam_192_168_3_40.dissector(buffer, pinfo, tree)
    if buffer:len() == 0 then return end
    pinfo.cols.protocol = "noam (192.168.3.40)"
    local subtree = tree:add(noam_192_168_3_40, buffer(), "noam for IP 192.168.3.40")
    local offset = 0
...
udp_port:add(10000, noam_192_168_3_40)
